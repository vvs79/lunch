...
User.create!(login: 'admin', first_name: 'Admin', last_name: 'Admin', email:
'a@a.com', password: '87654321', admin: true)
User.create!(login: 'user', first_name: 'User', last_name: 'User', email:
'u@u.com', password: '12345678', admin: false)
...
25.times do |i|
  ...
  User.create!(login: login, first_name: first_name, last_name: last_name, email:
  email, password: '12345678', admin: false)
end
